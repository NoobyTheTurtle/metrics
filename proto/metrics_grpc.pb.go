...
//
// MetricsService предоставляет gRPC API для работы с метриками
type MetricsServiceClient interface {
	// UpdateMetric обновляет одну метрику и возвращает обновленное значение
	...
	// GetMetric получает значение метрики по имени и типу
	GetMetric(ctx context.Context, in *GetMetricRequest, opts ...grpc.CallOption) (*GetMetricResponse, error)
	// Ping проверяет доступность сервиса и соединения с базой данных

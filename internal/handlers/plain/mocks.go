...
// Source: internal/handlers/plain/interfaces.go
//
// Generated by this command:
//
//	mockgen -source=internal/handlers/plain/interfaces.go -destination=internal/handlers/plain/mocks.go -package=plain
//
...
func (m *MockHandlerLogger) Error(format string, args ...any) {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a := range args {
...
func (mr *MockHandlerLoggerMockRecorder) Error(format any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockHandlerLogger) Info(format string, args ...any) {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockHandlerLoggerMockRecorder) Info(format any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{format}, args...)
